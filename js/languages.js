...
const translations = {
    en: {
        ...
        listedRooms: "Rooms listed",
        postedBy: "Posted by",
        seeAllRoomsFrom: "See all their rooms",
        shareProfile: "Share this profile",
        profileNotFound: "Landlord not found",
        listedOnStudentStay: "listed on StudentStay",
        viewOwnerProfile: "View room owner profile",
        ...
        imagesHint: "Select up to 5 images (JPG, PNG).",
        coverHint: "Tap the star on a photo to make it the cover photo shown on listing cards.",
        coverBadge: "Cover",
        ...
        renew: "Renew",
        expired: "Expired",
        noFreeListings: "You've used all your free listings for now.",
        postedAsLabel: "Posting as",
        postedAsOwner: "Room owner",
        postedAsAgent: "Agent",
    ...
    fr: {
        ...
        shareRoom: "Partager cette chambre",
        linkCopied: "Lien copié !",
        listedRooms: "Chambres publiées",
        postedBy: "Publié par",
        seeAllRoomsFrom: "Voir toutes ses chambres",
        shareProfile: "Partager ce profil",
        profileNotFound: "Propriétaire introuvable",
        listedOnStudentStay: "publiée(s) sur StudentStay",
        viewOwnerProfile: "Voir le profil du propriétaire",
        ...
        imagesHint: "Sélectionnez jusqu'à 5 images (JPG, PNG).",
        coverHint: "Appuyez sur l'étoile d'une photo pour en faire la photo de couverture affichée sur les fiches.",
        ...
        creatingRoom: "Création de l'annonce...",
        ...
        renew: "Renouveler",
        expired: "Expirée",
        noFreeListings: "Vous avez utilisé toutes vos annonces gratuites pour l'instant.",
        postedAsLabel: "Publier en tant que",
        postedAsOwner: "Propriétaire",
        postedAsAgent: "Agent",
        suggestions: "Suggestions",
